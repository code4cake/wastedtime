...
declare module 'inquirer' {
  // declare module.exports: any // [ASK]: came with the stub maybe need to uncommented later

  declare export type Inquirer = Object
  declare export type Prompt = Object
  declare export type Questions = Array<Question>
  declare export type Answers = Array

  declare export type Question = {|
    type?: string,
    name?: string,
    message?: string | Function,
    default?: string | number | boolean | Array<mixed> | Function,
    choices?: Array<mixed> | Function,
    validate?: Function,
    filter?: Function,
  ...
  declare module.exports: {
    prompt(questions: Questions): Promise<>,
    registerPrompt(name: string, prompt: Prompt): void,
    createPromptModule(): typeof prompt, // [ASK] this returns the prompt method
  }
}
