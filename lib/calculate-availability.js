...
// @format
function calculateAvailability(meetingHours, workingHours) {
...
function logMessage(percentage) {
  let logMessages = {
    ...
    moreThan50: `🚨 ${percentage}% 🚨 ${percentage}% 🚨 ${percentage}% 🚨 ${percentage}% 🚨. I hope me calling this number so many times have made an impact on you. Here it is again ${percentage}%.` // if less than 10
